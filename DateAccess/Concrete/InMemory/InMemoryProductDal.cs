    ...
    public class InMemoryProductDal : IProductDal
    {
        ...
        public InMemoryProductDal()
        {
            ...
            _products = new List<Product> {
                ...
                new Product{ProductId=2,CategoryId=1,ProductName="Klavye",UnitPrice=150,UnitsInStock=65},
                new Product{ProductId=2,CategoryId=1,ProductName="Fare",UnitPrice=85,UnitsInStock=1},
            };
        }
